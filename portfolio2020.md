...
- Resolved Delta pricing discrepancy issue for the PRIME brokerage business line that upon investigation was caused from assets which were indexes over indexes. Resolved by correcting the ensuring the underlying index was supplying dependent market data based on full risk decomposition as the fuller set of market data provided the Pnl Attribution quant operation the proper price. Resulted in a deeper understanding of decomposed vs non-decomposed risk pricing for indexes over indexes.
